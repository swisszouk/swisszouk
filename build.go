...
func (r *renderer) renderAll() {
	...
	schools := []School{
		...
		{"https://www.zoukies.ch", "", "Dance embodiment, zouk and yoga in Basel and Bern.",
			"A dance school and community for people who want to learn zouk in combination with spiritual development."},
